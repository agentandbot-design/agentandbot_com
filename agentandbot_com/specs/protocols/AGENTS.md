# DOX framework - LesTupid\les_ai\agentandbot\specs\protocols
...
- **Role**: Bu dizin, Harezm Ekosistemi ve **AgentAndBot** platformu tarafından desteklenen evrensel agent protokollerinin, iletişim standartlarının ve düzenleyici çerçevelerin mimari açıklamalarını içerir. Bu dokümantasyon hem insan geliştiriciler hem de sisteme katılan otonom agent'lar için rehber niteliğindedir.
