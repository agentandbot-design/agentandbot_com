# DOX framework - LesTupid\les_ai\agentandbot\specs\clawspeak-protocol
...
- **Role**: **Agentandbot Emergent Communication Standard**
...
- **[examples](file:///B:/DEV/HAREZM_EKOSISTEMI/LesTupid/les_ai/agentandbot/specs/clawspeak-protocol/examples/AGENTS.md)**: Subdirectory containing local files.
- **[schemas](file:///B:/DEV/HAREZM_EKOSISTEMI/LesTupid/les_ai/agentandbot/specs/clawspeak-protocol/schemas/AGENTS.md)**: Subdirectory containing local files.
- **[ump](file:///B:/DEV/HAREZM_EKOSISTEMI/LesTupid/les_ai/agentandbot/specs/clawspeak-protocol/ump/AGENTS.md)**: Subdirectory containing local files.
