# DOX framework - LesTupid\les_ai\agentandbot\services\cv_generator
...
- **Role**: Service-side CV generator integration.
- **Surface**: Service under AgentAndBot/e-any.online
- **Type**: backend/service
- **Audience**: CV generation workflows
- **Technology**: Python service
- **GitHub**: [`https://github.com/ilkerkaanipcioglu/lestupid/tree/main/les_ai/agentandbot/services/cv_generator`](`https://github.com/ilkerkaanipcioglu/lestupid/tree/main/les_ai/agentandbot/services/cv_generator`)

## Workspace Index

Below is the directory mapping for this subtree:

- **[tests](file:///B:/DEV/HAREZM_EKOSISTEMI/LesTupid/les_ai/agentandbot/services/cv_generator/tests/AGENTS.md)**: Subdirectory containing local files.
- **[__pycache__](file:///B:/DEV/HAREZM_EKOSISTEMI/LesTupid/les_ai/agentandbot/services/cv_generator/__pycache__/AGENTS.md)**: Subdirectory containing local files.
